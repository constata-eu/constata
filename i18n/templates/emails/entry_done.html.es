...
{% block footer %}
  La certificación consiste en un sello de tiempo en la blockchain de Bitcoin.
  Están en formato HTML para contener los documentos originales y pueden ser visualizados en cualquier dispositivo.
  <br>
  Sus datos de contacto son utilizados con el único propósito e
  interés legítimo de remitirle este mensaje.
  Si usted tiene alguna consulta acerca del tratamiento de sus datos
  personales, o de las actividades de Constata.eu, puede comunicarse con nosotros a
  <a href="malito:hola@constata.eu">hola@constata.eu</a>
{% endblock footer %}
