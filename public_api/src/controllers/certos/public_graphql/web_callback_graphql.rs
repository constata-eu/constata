use super::*;
use constata_lib::models::web_callback::{self,
  SelectWebCallback, WebCallbackOrderBy, WebCallbackKind, WebCallbackState,
...
#[rocket::async_trait]
impl Showable<web_callback::WebCallback, WebCallbackFilter> for WebCallback {
  ...
  async fn db_to_graphql(d: web_callback::WebCallback, _with_payload: bool) -> MyResult<Self> {
...
#[rocket::async_trait]
impl Showable<web_callback::WebCallbackAttempt, WebCallbackAttemptFilter> for WebCallbackAttempt {
  ...
  async fn db_to_graphql(d: web_callback::WebCallbackAttempt, _with_payload: bool) -> MyResult<Self> {
