...
#[rocket::async_trait]
impl Showable<kyc_request_evidence::KycRequestEvidence, KycRequestEvidenceFilter> for KycRequestEvidence {
  ...
  async fn db_to_graphql(d: kyc_request_evidence::KycRequestEvidence) -> MyResult<Self> {
