...
#[rocket::async_trait]
impl Showable<db::PubkeyDomainEndorsement, PubkeyDomainEndorsementFilter> for PubkeyDomainEndorsement {
  ...
  async fn db_to_graphql(d: db::PubkeyDomainEndorsement ) -> ConstataResult<Self> {
