        ...
        <Toolbar sx={{ minHeight: "0 !important" }}>
          <Box sx={{ display: "flex" }}>
            ...
            >
              <img
                src={logo}
                alt={translate("certos.menu.logo")}
                style={{ height: isSmall ? "20px" : "30px", width: "auto" }}
              />
            </a>
          </Box>
          {loggedIn && (
  ...
  return (
    <Root>
      ...
      <AppFrame>
        ...
        <Alert sx={{ mt: "1em" }} severity="warning" variant="filled">
          <Typography>{t("certos.dashboard.no_more_issuance")}</Typography>
          <Typography>{t("certos.dashboard.download_and_view")}</Typography>
        </Alert>
